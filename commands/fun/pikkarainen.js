...
module.exports = {
    ...
    execute(message = Discord.Message.prototype, args = []) {
        ...
        const data = JSON.parse(fs.readFileSync('/home/ubuntu/Lilith/data/pictures.json').toString())
        const randomNumber = Math.floor(data.length * Math.random())

        console.log(data[randomNumber])
        // message.channel.send(data[randomNumber])

        const EmbedVinkkari = new Discord.MessageEmbed()
        ...
        message.channel.send({ embeds: [EmbedVinkkari] })

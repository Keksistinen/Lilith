...
module.exports = {
    ...
    execute(message = Discord.Message.prototype, args = []) {
        ...
        const subreddit = 'boobs' // Haluttu subreddit

        getPics()
        async function getPics() {
            const amount = 700 // Kuinka monta se kaivaa
            let images = []
            ...
            fs.writeFileSync("/home/ubuntu/Lilith/data/pictures.json", JSON.stringify(images, null, 2))
        }
